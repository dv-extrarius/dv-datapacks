...
scoreboard players operation rand3A rndgenVariable /= RandHiDivisor rndgenConstant
scoreboard players operation rand3A rndgenVariable %= RandHiModulus rndgenConstant
scoreboard players operation rand3A rndgenVariable += RandHiModulus rndgenConstant
scoreboard players operation rand3A rndgenVariable %= RandHiModulus rndgenConstant
...
scoreboard players operation rand3B rndgenVariable /= RandLowDivisor rndgenConstant
scoreboard players operation rand3B rndgenVariable %= RandLowModulus rndgenConstant
scoreboard players operation rand3B rndgenVariable += RandLowModulus rndgenConstant
scoreboard players operation rand3B rndgenVariable %= RandLowModulus rndgenConstant
