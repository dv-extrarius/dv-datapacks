...
scoreboard players operation rand2A rndgenVariable /= RandHiDivisor rndgenConstant
scoreboard players operation rand2A rndgenVariable %= RandHiModulus rndgenConstant
scoreboard players operation rand2A rndgenVariable += RandHiModulus rndgenConstant
scoreboard players operation rand2A rndgenVariable %= RandHiModulus rndgenConstant
...
scoreboard players operation rand2B rndgenVariable /= RandLowDivisor rndgenConstant
scoreboard players operation rand2B rndgenVariable %= RandLowModulus rndgenConstant
scoreboard players operation rand2B rndgenVariable += RandLowModulus rndgenConstant
scoreboard players operation rand2B rndgenVariable %= RandLowModulus rndgenConstant
